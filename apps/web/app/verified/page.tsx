    ...
    <div className="flex min-h-screen max-w-[1020px] mx-auto">
      ...
      <aside className="w-[210px] flex-shrink-0 bg-[var(--surface)] border-r border-[var(--border)] flex flex-col">
        ...
        <nav className="p-2 flex-1">
          ...
          <Link href="/verified" className="flex items-center gap-2 px-2.5 py-2 rounded-md text-[13px] text-[var(--accent2)] bg-[rgba(34,201,122,0.08)] border border-[rgba(34,201,122,0.25)] mb-0.5">
      ...
      <main className="flex-1 min-w-0 flex flex-col">
        <div className="flex items-center gap-3 px-5 py-3.5 border-b border-[var(--border)] bg-[var(--surface)]">
          <span className="font-mono text-[11px] text-[var(--text3)]">
            TEVAD.RO <span className="text-[var(--text2)]">/</span> <span className="text-[var(--green)]">VERIFICATE ADEVĂRATE</span>
          </span>
          <span className="font-mono text-[10px] text-[var(--green)] ml-auto">
          ...
          {(records ?? []).map((rec, i) => {
            ...
            return (
              <Link
                ...
                className="flex items-start gap-3 px-5 py-3.5 border-b border-[var(--border)] border-l-2 border-l-[var(--green)] hover:bg-[rgba(34,201,122,0.03)] transition-colors group animate-fade-up"
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-1.5">
                    <span className="font-mono text-[8px] px-1.5 py-0.5 rounded-sm border bg-[rgba(34,201,122,0.1)] text-[var(--green)] border-[rgba(34,201,122,0.3)]">
                      ADEVĂRAT
                    </span>
