        ...
        {(records ?? []).map((rec, i) => {
          ...
          return (
            <Link
              ...
              className="flex items-start gap-3 px-5 py-3.5 border-b border-[var(--border)] border-l-2 border-l-[var(--green)] hover:bg-[rgba(34,201,122,0.03)] transition-colors animate-fade-up"
